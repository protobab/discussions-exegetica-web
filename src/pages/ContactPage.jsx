...
export default function ContactPage() {
  ...
  const inputStyle = { width: '100%', border: '1px solid #D4C9AE', borderRadius: 8, padding: '10px 13px', fontFamily: F.body, fontSize: 14, outline: 'none', boxSizing: 'border-box', marginBottom: 14 }
  ...
  return (
    <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', background: C.parchment }}>
      <div style={{ background: '#fff', borderRadius: 16, padding: '38px 32px', width: '100%', maxWidth: 520, boxShadow: '0 4px 32px rgba(0,0,0,0.08)' }}>
        ...
        <h1 style={{ fontFamily: F.display, fontSize: 22, fontWeight: 700, color: '#2C2416', textAlign: 'center', marginBottom: 6 }}>Get in Touch</h1>
        <p style={{ fontFamily: F.body, fontSize: 13.5, color: '#5a5346', textAlign: 'center', marginBottom: 16, lineHeight: 1.6 }}>
        ...
        <div style={{ background:'rgba(201,168,76,0.08)', border:'1px solid rgba(201,168,76,0.2)', borderRadius:10, padding:'12px 16px', marginBottom:20, textAlign:'center' }}>
          <p style={{ fontFamily: F.body, fontSize: 12.5, color: '#5a5346', margin:0, lineHeight:1.6 }}>
        ...
        <p style={{ fontFamily: F.body, fontSize: 12.5, color: '#5a5346', textAlign: 'center', marginTop: 16 }}>
