      ...
      <div style={{ display:'grid', gap:12, marginBottom:16 }}>
        <div>
          ...
          <textarea value={text} onChange={e=>setText(e.target.value)} placeholder="e.g. 🎙 Our next Armchair session is this Sunday at 7pm — join us live!" rows={3}
            style={{ width:'100%', border:'1px solid rgba(201,168,76,0.25)', borderRadius:8, padding:'10px 13px', fontFamily:F.body, fontSize:14, outline:'none', resize:'vertical', boxSizing:'border-box', background:'var(--fg-08)', color:'var(--fg-100)', colorScheme:'dark', pointerEvents:'auto' }}/>
        </div>
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:12 }}>
          <div>
            ...
            <select value={type} onChange={e=>setType(e.target.value)} style={{ width:'100%', border:'1px solid rgba(201,168,76,0.25)', borderRadius:8, padding:'9px 12px', fontFamily:F.body, fontSize:13.5, outline:'none', background:'var(--fg-08)', color:'var(--fg-100)', colorScheme:'dark', pointerEvents:'auto' }}>
          ...
          <div>
            ...
            <select value={hours} onChange={e=>setHours(parseInt(e.target.value))} style={{ width:'100%', border:'1px solid rgba(201,168,76,0.25)', borderRadius:8, padding:'9px 12px', fontFamily:F.body, fontSize:13.5, outline:'none', background:'var(--fg-08)', color:'var(--fg-100)', colorScheme:'dark', pointerEvents:'auto' }}>
