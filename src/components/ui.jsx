...
export function Logo({ size = 34 }) {
  ...
  return (
    <svg width={w} height={h} viewBox="0 0 72 78" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M16 66 Q36 63 56 66" stroke="#C9A84C" strokeWidth="1.6" strokeLinecap="round" fill="none" opacity="0.55"/>
      <path d="M22 70 Q36 68 50 70" stroke="#C9A84C" strokeWidth="1" strokeLinecap="round" fill="none" opacity="0.3"/>
    </svg>
  )
}
